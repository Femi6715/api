    ...
    <?php else : ?>
        ...
        <div class="printful-debug-section" style="margin: 20px 0; padding: 15px; border: 1px solid #ddd; background-color: #f9f9f9;">
            ...
            <div class="printful-debug-info">
                ...
                <ul>
                    <li><strong><?php echo esc_html__('Products API Key Set:', 'printful-resources'); ?></strong> <?php echo !empty($products_api_key) ? 'âœ“' : 'âœ—'; ?></li>
                    <?php 
                    // Check if WooCommerce is active
                    $woocommerce_active = class_exists('WooCommerce');
                    ?>
                    <li><strong><?php echo esc_html__('WooCommerce Active:', 'printful-resources'); ?></strong> <?php echo $woocommerce_active ? 'âœ“' : 'âœ—'; ?></li>
                </ul>
