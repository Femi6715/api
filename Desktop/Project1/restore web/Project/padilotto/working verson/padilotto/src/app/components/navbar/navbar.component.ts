...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  closeMobileDropdown() {
    const activeMenuItem = document.querySelector('.menu_has_children.active');
    if (activeMenuItem) {
      activeMenuItem.classList.remove('active');
      const submenu = activeMenuItem.querySelector('.sub-menu') as HTMLElement;
      if (submenu) {
  ...
  toggleMobileMenu(event: Event, menuItem: any) {
